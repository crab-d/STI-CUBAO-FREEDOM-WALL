            ...
            <div class="d-flex flex-column align-items-start w-100">
                ...
                <div class="d-flex ms-4 mb-0">
                    ...
                    <input type="hidden" name="post_id" value="'. $row["post_id"] .'">
                        <input  id="reply_input"  class="border primary-fs  reply_input p-1 w-100 m-0 comment-input-box rounded border-0 bg-light shadow-sm" placeholder="Comment as ' . getUserDisplayName($account_id) . '" autocomplete="off">
